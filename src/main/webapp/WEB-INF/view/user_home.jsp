...
<li> <a class="text-white" href="user_profile.jsp">Welcome, <span class="font-bold"><img src="images/avatar.jpg" class="thumb-sm m-t-n m-b-n"> User</span> </a> </li> 
        </ul>
    	<ul class="nav navbar-nav navbar-right hidden-xs nav-user"> 
        	<li> <a href="user_home.jsp" class="text-white"><span class="font-bold"><i class="fa fa-home"></i> Home</span> </a> </li> 
        	<li> <a href="modals/setting.html" data-toggle="ajaxModal" class="text-white"><span class="font-bold"><i class="fa fa-cog"></i> Setting</span> </a> </li> 
